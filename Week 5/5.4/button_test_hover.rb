...
class DemoWindow < Gosu::Window
  ...
  def draw
    ...
    # ????
    if ((mouse_x > 170 && mouse_x < 270) && (mouse_y > 50 && mouse_y < 100))
      Gosu.draw_rect(168, 48, 104, 54, Gosu::Color::BLACK, ZOrder::MIDDLE, mode=:default)
    end
    # Draw the button text
    @button_font.draw("Click me", 180, 70, ZOrder::TOP, 1.0, 1.0, Gosu::Color::BLACK)
    # Draw the button
    Gosu.draw_rect(170, 50, 100, 50, Gosu::Color::GREEN, ZOrder::MIDDLE, mode=:default)
